...
`,
  ...
  text: {
    ...
    event: {
      home: "Sự kiện sắp diễn ra",
      homeSubtitle: "Khám phá các hội nghị & workshop của SMB+",
      ...
      voucher: "Voucher",
      about: "Về sự kiện",
      benefits: "Lợi ích khi tham dự",
      speakers: "Diễn giả",
      schedule: "Lịch trình",
      venue: "Địa điểm",
      hotels: "Khách sạn đề xuất",
      gallery: "Thư viện ảnh",
      sponsors: "Nhà tài trợ",
      faq: "Câu hỏi thường gặp",
      prices: "Gói tham dự",
      amenities: "Tiện ích bao gồm",
      empty: "Chưa có sự kiện nào đang hoạt động",
      deadline: "Hạn cuối đăng ký",
      days: "ngày",
      hours: "giờ",
      mins: "phút",
      secs: "giây",
      toEvent: "Đến ngay sự kiện",
      checkIn: "Tình trạng tham dự",
      ...
      backToHome: "Về trang chủ",
      registerSuccess: "Đăng ký sự kiện thành công!",
      registerSuccessHint: "Mã vé đã được tạo, hãy giữ QR để check-in tại sự kiện.",
      registerInfo: "Thông tin đăng ký",
      optional: "Tùy chọn",
      companySize: "Quy mô công ty",
      interestedProducts: "Phần mềm quan tâm",
      ticket: "Vé",
      qrHint: "Đưa mã QR này tại quầy check-in",
      noTicket: "Bạn chưa có vé nào",
      noTicketHint: "Hãy đăng ký một sự kiện để nhận vé tham dự.",
      logOut: "Đăng xuất",
      logOutHint: "Xoá thông tin đăng nhập trên thiết bị này.",
      customerNotFound: "Chưa tìm thấy thông tin khách hàng",
      continue: "Tiếp tục",
      goingToEvent: "Sự kiện đang chờ bạn!",
    },
    home: {
